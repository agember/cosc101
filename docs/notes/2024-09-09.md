...
print("1. Preheat oven to 375°F. Put liners in" + str(int(dozen) * 12) + "muffin cups.")

print("2. Cream butter and sugar until light and fluffy. Beat in eggs one at a time.")

print("3. Combine flour", "salt", "and baking soda.")

print("4. Add flour mixture and milk to butter and sugar; beat well.")

print("5. Divide batter evenly among" + str(int(dozen) * 12) + "muffin cups.")

print("6. Bake for 18 minutes or until a toothpick comes out clean. Cool in pans.")
...
print("3. Cream butter and sugar until light and fluffy.")
print("4. Beat in eggs one at a time.")
print("5. Combine flour, salt, and baking soda.")
print("6. Add flour mixture and milk to butter and sugar; beat well.")
print("7. Divide batter evenly among muffin cups.")
print("8. Bake for 18 minutes or until a toothpick comes out clean.")
print("9. Cool in pans and enjoy!")
```
    ...
    * 1.0 cups milk
    ...
    6. Add flour mixture and milk to butter and sugar; beat well.
    7. Divide batter evenly among muffin cups.
    8. Bake for 18 minutes or until a toothpick comes out clean.
    9. Cool in pans and enjoy!
